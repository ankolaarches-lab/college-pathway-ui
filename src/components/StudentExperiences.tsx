            ...
            {contributions.length === 0 ? (
                ...
                <div className="grid md:grid-cols-2 gap-4">
                    {contributions.map((contribution) => (
                        <div key={contribution.id} className="p-4 bg-white border border-slate-200 rounded-xl hover:shadow-md transition-shadow">
                            ...
                            <div className="flex items-center gap-2 mt-3 pt-3 border-t border-slate-50">
                                <span className={`text-[10px] font-bold px-2 py-0.5 rounded-full ${contribution.verification_status === 'verified'
                                    ...
                                    {contribution.verification_status.toUpperCase()}
                                </span>
