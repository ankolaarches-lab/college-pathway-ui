                                ...
                                <div className="flex justify-between items-end">
                                    ...
                                    <div className="flex gap-4">
                                        <span className="flex items-center gap-1.5 text-xs font-bold text-slate-800">
                                            <div className="w-2.5 h-2.5 rounded-full bg-teal-400"></div>W
                                        </span>
                                        <span className="flex items-center gap-1.5 text-xs font-bold text-slate-800">
                                            <div className="w-2.5 h-2.5 rounded-full bg-indigo-500"></div>M
                                        </span>
                                    </div>
                                </div>
                ...
                {college.crime_stats && (
                    <section className="glass-card p-10 relative overflow-hidden group">
                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10 pb-8 border-b border-slate-100">
                            ...
                            <span className="badge bg-rose-50 text-rose-600 border border-rose-100 font-black">Latest 3-Year Audit</span>
                        </div>
